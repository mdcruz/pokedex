...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PokemonApp.AndroidExtensions.SearchFilter, PokemonApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SearchFilter.class, __md_methods);
	}
	...
	public SearchFilter () throws java.lang.Throwable
	{
		...
		if (getClass () == SearchFilter.class)
			mono.android.TypeManager.Activate ("PokemonApp.AndroidExtensions.SearchFilter, PokemonApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public SearchFilter (md5a0b895b54db2e11d2a4e3b9b15b83db4.CustomImageAdapter p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == SearchFilter.class)
			mono.android.TypeManager.Activate ("PokemonApp.AndroidExtensions.SearchFilter, PokemonApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "PokemonApp.AndroidExtensions.CustomImageAdapter, PokemonApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
